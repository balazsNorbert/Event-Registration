        ...
        >
            <form @submit.prevent="submit" class="p-8 space-y-6">
                ...
                >
                    ...
                    <div v-if="event.image_path" class="mb-4 text-center">
                        ...
                        <div class="flex justify-center">
                            <img
                                ...
                                class="h-28 object-cover rounded-lg shadow-md border border-gray-200"
                            />
                        </div>
                    </div>
                ...
                >
                    ...
                    >
                        <span v-if="form.processing">Mentés...</span>
                        <span v-else>Módosítások mentése</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        return {
            form: useForm({
                ...
                event_date: this.event.event_date
                    ? this.event.event_date.replace(" ", "T")
                    : "",
